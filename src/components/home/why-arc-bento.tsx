    ...
    >
      <div className="max-w-7xl mx-auto space-y-16">
        ...
        <div ref={bentoRef} className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-8 p-8 sm:p-12 rounded-2xl bg-[#1C1A17] border border-white/10 relative overflow-hidden flex flex-col justify-between group hover:border-[#C9A86A]/50 transition-all duration-500 shadow-xl">
            <div className="space-y-4 z-10">
              <div className="flex items-center space-x-2 text-amber-400/90">
                {[...Array(5)].map((_, i) => (
                  <Star key={i} className="w-5 h-5 fill-amber-400/90 text-amber-400/90" />
                ))}
                <span className="text-xs font-mono font-semibold text-[#FBF9F5] ml-2">5.0 / 5.0 RATING</span>
              </div>
              <h3 className="font-serif text-3xl sm:text-4xl text-[#FBF9F5] font-normal max-w-lg leading-snug">
            ...
            <div className="pt-8 flex items-center justify-between z-10 border-t border-white/10 mt-6">
              ...
              <a
                ...
                className="inline-flex items-center space-x-1 text-xs font-mono text-[#CCC5B9] hover:text-[#C9A86A] transition-colors"
              >
          ...
          <div className="lg:col-span-4 p-8 sm:p-10 rounded-2xl bg-[#1C1A17] border border-white/10 flex flex-col justify-between group hover:border-[#C9A86A]/50 transition-all duration-500 shadow-xl">
          ...
          <div className="lg:col-span-8 p-8 sm:p-10 rounded-2xl bg-[#1C1A17] border border-white/10 relative overflow-hidden flex flex-col justify-between group hover:border-[#C9A86A]/50 transition-all duration-500 shadow-xl">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div className="space-y-4">
                ...
                <div className="pt-2">
                  <Link
                    href="/craftsmanship"
                    className="inline-flex items-center space-x-1 text-xs font-mono text-[#C9A86A] hover:underline"
                  >
              ...
              <div className="grid grid-cols-2 gap-4 text-xs font-mono">
                <div className="p-4 rounded-xl bg-[#24221D] border border-white/5 space-y-1">
                  <span className="text-[10px] text-[#8E887E] block">CONCRETE TESTING</span>
                  <span className="text-[#FBF9F5] font-semibold block">Cube Crushing 28-Day</span>
                  <span className="text-[#C9A86A] text-[10px]">Verified Strength</span>
                </div>
                <div className="p-4 rounded-xl bg-[#24221D] border border-white/5 space-y-1">
                  <span className="text-[10px] text-[#8E887E] block">STEEL STANDARD</span>
                  <span className="text-[#FBF9F5] font-semibold block">Fe-550D TMT</span>
                  <span className="text-[#C9A86A] text-[10px]">Anti-Corrosive Coated</span>
                </div>
                <div className="p-4 rounded-xl bg-[#24221D] border border-white/5 space-y-1">
                  <span className="text-[10px] text-[#8E887E] block">WATERPROOFING</span>
                  <span className="text-[#FBF9F5] font-semibold block">Elastomeric Membrane</span>
                  <span className="text-[#C9A86A] text-[10px]">10-Year Guarantee</span>
                </div>
                <div className="p-4 rounded-xl bg-[#24221D] border border-white/5 space-y-1">
                  <span className="text-[10px] text-[#8E887E] block">PLUMBING LINES</span>
                  <span className="text-[#FBF9F5] font-semibold block">Multi-Layer CPVC</span>
                  <span className="text-[#C9A86A] text-[10px]">15-Bar Tested</span>
                </div>
              </div>
            </div>
          </div>
